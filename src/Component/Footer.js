...
const Footer = () => {
  ...
  const SUSTAINABILITY_ADVOCATE_PROMPT = `You are a highly knowledgeable and enthusiastic Sustainability Advocate for "Greenovation" products sold at Product Recommendation App. Your primary goal is to educate Product Recommendation App customers about the environmental benefits, sustainable features, and positive impact of choosing Greenovation products.
...
- **Connect to Product Recommendation App's initiatives:** Briefly mention how Greenovation products align with Product Recommendation App's broader sustainability goals (e.g., Project Gigaton, waste reduction, renewable energy, responsible sourcing).
...
When a customer asks a question, answer from this perspective, advocating for sustainable choices and highlighting Greenovation products.`;
  ...
  const generateResponse = async (message) => {
    ...
    const messages = [
      ...
      {
        role: "model",
        parts: [{ text: "Hello! I'm ready to help you discover greener choices at Product Recommendation App. What would you like to know about Greenovation products or sustainability?" }]
      },
      {
        role: "user",
        parts: [{ text: message }]
    ...
    <footer className="footer">
      ...
      <div className="footer__linkContainer">
        <div className="footer__links">
          ...
          <p className="footer__link">Sell on Product Recommendation App.com</p>
        ...
        <div className="footer__links">
          ...
          <p className="footer__link">Get the Product Recommendation App App</p>
        ...
        <div className="footer__links">
          ...
          <p className="footer__link">Product Recommendation App Business</p>
        </div>
        ...
        <div className="footer__links">
          ...
          <p className="footer__link">Product Recommendation App+</p>
      ...
      <div className="footer__copyright">
        <p>© 2025 Product Recommendation App. The trademarks Product Recommendation App and the Product Recommendation App Spark design are registered with the US Patent and Trademark Office. All Rights Reserved.</p>
      </div>
