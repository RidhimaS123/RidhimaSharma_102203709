      ...
      <div className="login__container">
        <div className="login__left">
          <div className="login__branding">
            ...
            <h1>Welcome to Product Recommendation App</h1>
              ...
              {activeTab === 'register' && (
                <>
                  ...
                  <div className="form__checkbox">
                    ...
                    />
                    <label>
                      I agree to Product Recommendation App's <a href="#" className="link">Terms of Service</a> and <a href="#" className="link">Privacy Policy</a>
                    </label>
