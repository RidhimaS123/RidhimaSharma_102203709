    ...
    <div className="home">
      <div className="home__container">
        ...
        <div className="home__hero">
          <h1>🌱 Shop Sustainably with Product Recommendation App</h1>
        ...
        <div className="home__deals-grid">
          ...
          {/* Center - Main Product Recommendation App Deals with Floating Carousel */}
          <div className="home__main-deal">
            <div className="home__main-deal-content">
              <h2>Product Recommendation App</h2>
              <h1>DEALS</h1>
              <p>JULY 8-15 ONLY!</p>
          ...
          <div className="home__deal-card home__deal-card--small">
            <div className="home__deal-content">
              <h4>Get 50% off annual Product Recommendation App+ membership</h4>
              <div className="home__product-mini">
                <Product
                  id="23445930"
                  title="Echo Speaker"
