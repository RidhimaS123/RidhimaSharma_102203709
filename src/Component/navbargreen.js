...
const AmazonNavigationBarg = () => {
  ...
  <li><button className="nav-button-blue">Only at Product Recommendation App</button></li>
  <li><button className="nav-button-blue">Registry</button></li>
  <li><button className="nav-button-blue">Product Recommendation App+</button></li>
